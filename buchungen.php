...
<html lang="de">
  ...
  <input type="text" class="form-control ml-2" placeholder="Suchbegriff" aria-label="Suche" aria-describedby="basic-addon1">
    ...
    <span class="btn btn-dark" id="basic-addon2">Suche</span>
      ...
      <!-- überflüssig
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">Alles</a>
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">5 Jahre</a>
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">3 Jahre</a>
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">2 Jahre</a>
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">1 Jahr</a>
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">6 Monate</a>
      <a href="#" class="btn btn-dark  active" role="button" aria-pressed="true">3 Monate</a>
